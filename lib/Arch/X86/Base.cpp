...
llvm::CallingConv::ID X86ArchBase::DefaultCallingConv(void) const {
  if (IsX86()) {
    switch (os_name) {
      ...
      case OSName::kOSSolaris: return llvm::CallingConv::C;  // cdecl.
    }
  } else {
    switch (os_name) {
      case OSName::kOSInvalid:
      case OSName::kOSmacOS:
      case OSName::kOSLinux:
      case OSName::kOSSolaris: return llvm::CallingConv::X86_64_SysV;
      case OSName::kOSWindows: return llvm::CallingConv::Win64;
    }
  }
}
...
llvm::Triple X86ArchBase::Triple(void) const {
  ...
  switch (arch_name) {
    ...
    case ArchName::kArchAMD64_SLEIGH: triple.setArch(llvm::Triple::x86_64); break;
    case ArchName::kArchX86:
    case ArchName::kArchX86_AVX:
    case ArchName::kArchX86_AVX512:
    case ArchName::kArchX86_SLEIGH: triple.setArch(llvm::Triple::x86); break;
    default:
...
llvm::DataLayout X86ArchBase::DataLayout(void) const {
  ...
  switch (os_name) {
    ...
    case OSName::kOSLinux:
    case OSName::kOSSolaris:  // Probably.
      switch (arch_name) {
        case ArchName::kArchAMD64:
        case ArchName::kArchAMD64_AVX:
        case ArchName::kArchAMD64_AVX512:
...
void X86ArchBase::PopulateRegisterTable(void) const {
  ...
  switch (arch_name) {
    case ArchName::kArchX86_AVX:
    case ArchName::kArchAMD64_AVX: has_avx = true; break;
    case ArchName::kArchX86_AVX512:
    case ArchName::kArchAMD64_AVX512:
      has_avx = true;
      has_avx512 = true;
